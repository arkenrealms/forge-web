            ...
            <div>
              ...
              <p>
                <Linker id="about-1">
                  ...
                  blockchain, allowing us to deliver the power of ownership/transparency/modularity, while maintaining a
            ...
            <div>
              ...
              <p>
                <Linker id="about-2">
                  ...
                  still own what they pwn. In addition to that, we've designed the economy in a way that it rewards the
                  most talented players.
                  <br />
                  <br />
                  Each of our 33 runes have utility built into them, and can also be used for crafting. When rune tokens
                  are used for crafting, they are redistributed to players winning games or finding them randomly in the
                  game.
                  <br />
                  <br />
                  This is balanced to support economic inflows and outflows. For example, disenchanting an item will
                  give you LEM runes, and upgrading items will require LEM runes based on the global disenchant rate.
                  There's a ying and yang to each economy within the Arken Realms.
                </Linker>
              </p>
            </div>
          </PitchCard>
            ...
            <div>
              ...
              <ol>
                ...
                <li>
                  ...
                  always working towards better more refined products. Right now they do this through various polls and
              ...
              <ol>
                ...
                <li>
                  Agile Development - Make constant small improvements and get constant feedback, rather than trying to
                  take large bites of work.
                </li>
                <li>
                  Reward Early Adopters - The team is always thinking about how they can reward early adopters who stick
                ...
                <li>
                  ...
                  not nerf already minted items. Unless it was a bug, item attributes shouldn't be manipulated on our
                  end. This philosophy will help design better items, and not piss off early adopters, who are the ones
                  that will be rewarded the most anyway.
                </li>
              </ol>
            </div>
          </PitchCard>

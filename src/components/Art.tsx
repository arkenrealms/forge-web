...
import characterClasses from '@arken/node/legacy/data/generated/characterClasses.json';
import characterFactions from '@arken/node/legacy/data/generated/characterFactions.json';
import characterRaces from '@arken/node/legacy/data/generated/characterRaces.json';
import eras from '@arken/node/legacy/data/generated/eras.json';
import runeItems from '@arken/node/legacy/data/generated/items.json';
import npcs from '@arken/node/legacy/data/generated/npcs.json';
import planets from '@arken/node/legacy/data/generated/planets.json';
import solarSystems from '@arken/node/legacy/data/generated/solarSystems.json';

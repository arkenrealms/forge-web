...
const Forms = ({ themeConfig }: any) => {
  ...
  function getTabs({ params }: any) {
    ...
    //     <>
    //       Notes{' '}
    //       {contentItem?.commentsOnForms.length > 0 ? (
    //         <span
    //           css={css`
    //             position: absolute;
    //             top: 5px;
    ...
    //           `}
    //         >
    //           {contentItem.commentsOnForms.length} <BiCommentDetail />
    //         </span>
    //       ) : null}
    //     </>
    //   ),
    ...
    //         {
    //           label: '',
    //           name: 'recordUpdatesOnForms[].recordUpdate',
    //           type: 'history',
    //         },
    //       ],
    //     },

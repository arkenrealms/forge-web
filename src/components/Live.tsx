...
import { BaseLayout, Button, Card, Card2, Card3, CardBody, Heading, Skeleton, Text, Toggle } from '~/ui';
              ...
              X */}
                  ...
                  {[...Array(200).keys()].map((index) => (
                    <motion.div
                      ...
                      transition={{ duration: 2 }}>
                      <PlayerAction
                        action={playerNotices?.[index]?.data}
                        createdAt={playerNotices?.[index]?.createdAt}
                      />
                    </motion.div>
                  ))}
                </div>

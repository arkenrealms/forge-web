...
const DelistModal: React.FC<ListModalProps> = ({ tokenIds, onSuccess, onDismiss }) => {
  ...
  const { isApproving, isApproved, isConfirmed, isConfirming, handleApprove, handleConfirm } =
    useApproveConfirmTransaction({
      ...
      onConfirm: () => {
        return marketContract.methods.delistMultiple(Object.keys(tokenIds)).send({ from: account });
      },
      onSuccess: () => {
        refresh();

        toastSuccess(`Items delisted. Check back in a few minutes.`);

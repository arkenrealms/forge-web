...
const newsItems = [
  ...
  {
    title: 'Arken: Evolution Isles Season 2',
    href: 'https://arken.gg/evolution',
    image: 'https://pbs.twimg.com/media/Fbmr7LOagAA5udT?format=jpg&name=large',
    date: 'August 28, 2022',
    description: `Use your crafted NFTs to win your way to glory in Arken: Evolution Isles season 2 🎮`,
  },
  {
    title: 'Arken: Evolution Isles Season 1',
    href: 'https://arken.gg/tournament',
    image: 'https://i.imgur.com/ba1Jc3E.png',
    date: 'July 29, 2022',
    description: `Win cash & epic NFTs in the first Arken: Evolution Isles season, after Rune Royale on Twitch 🎮`,
  },
  {
    ...
    date: 'April 26, 2022',
    description: `You can now trade Arken items on @tofuNFT! Check out the Rune collection here👇`,
  },
  {
    title: 'Arken: Infinite Arena Announcement',
    ...
    date: 'March 28, 2022',
    description: `🔥Arken: Infinite Arena Earliest Access 📅 April 4 🔒 Exclusive access to Founder's Cube holders ➡️ Get your cube ready: arken.gg/cube`,
  },
  {
    ...
    date: 'March 18, 2022',
    description: `Raiders who owns a Founder's Cube may join in our Discord @ discord.gg/rune if you have a cube from arken.gg/cube`,
  },
  {
    title: 'Rune Nexus is here',
  ...
  {
    title: 'Gear Up with Rune - Round 4',
    href: 'https://gleam.io/TwANb/gear-up-with-rune-round-4',
    image: 'https://pbs.twimg.com/media/FNDKv15VcAMIOAk?format=jpg&name=large',
    date: 'March 5, 2022',
    description: `We are giving away another Founder's Cube and Fully Equipped Character! ($650 value!). Be one of the first to play Arken: Infinite Arena by winning a Founder's Cube!`,
  },
  {
    ...
    date: 'March 1, 2022',
    description: `Sneak peak for our upcoming #MMORPG Arken: Heart of the Oasis 👀 "At the end of all timelines lies this last bead of light."`,
  },
  {

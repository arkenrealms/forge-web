            ...
            <div className="div-block-32">
              ...
              <p className="paragraph white">
                ...
                <Linker id="energies-2">
                  ...
                  harnessed by mortals with the right training, talent, and circumstance. Only seven sub-types of energy
                  have been widely discovered so far, though many theorize that there could be more.
                </Linker>
              </p>
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-3">
                              ...
                              the source of this immense power. Source energy can be channeled into any other sub energy
                              and create any of their effects. Source energy taxes its users a great deal, often
                              rendering one bedridden after channeling it for a single instance. Source energy, if used
                              correctly, also has the unique ability to counter any other energy, for as long as one has
                              the stamina. Even the gods have barely scratched the surface of this universal energy.
                            </Linker>
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-4">
                              ...
                              understood energy on Haerra. Its use only began recently, when Zeno gifted the secrets of
                              temporal energy to the First Order of Zeno. Users of temporal energy can manipulate time
                              by slowing it down or speeding it up in their vicinity, gaze into the future or past, and
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-5">
                              Although chaos is not innately evil, Azorag sees chaos as a vessel for destruction, and he
                              gifts it to his followers to cause just that. Users of chaos energy can do a vast amount
                              of things--more than any other energy besides source. However, chaos magic is unstable and
                              unreliable, and can end in the destruction of both target and user. Users can tear at
                              reality, confuse foes or drive them to madness, and outright disintegrate enemies.
                            </Linker>
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-7">
                              ...
                              create storms by controlling the winds, part the earth with ease, and heal allies in times
                              of need.
                            </Linker>
                          </p>
                        </div>
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-8">
                              Although once subservient to astra energy, Relia broke her discipline away from Eledon to
                              focus on the nurturing and disciplinary properties of light. Users of kona energy can
                              wield fire in all its forms, create brilliant beacons of light to blind their enemies, and
                              increase their body temperatures to create immunity from the cold.
                            </Linker>
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-91">
                              Walarah's liberal provision of mana energy, somewhat ironically, inspires the most serious
                              and studious users. Since mana energy can be harnessed by anyone who seeks it, scholars
                              and mages spend their lives learning to harness this energy. Users of mana have the
                              greatest versatility of all the energies, although they often require components, actions,
                              and chants to create such varied magical effects.
                            </Linker>
                          </p>
                        </div>
                      </div>
                        ...
                        <div className="rich-text-block-6 w-richtext">
                          <p>
                            <Linker id="energies-10">
                              ...
                              powerful users can fly and channel burning divine energy into beams of destructive power.
                            </Linker>
                          </p>
                        </div>
                      </div>

        ...
        <main className="content-wrapper wf-section">
          ...
          <div>
            ...
            <div className="container hide-overflow w-container">
              ...
              <div className="locationdescription w-richtext">
                <p>
                  These are items that are purchased on the Arken Market, where all funds are used to go towards
                ...
                <ul role="list">
                  ...
                  <li>
                    ...
                    Collector's Edition, Early Access to Arken games, Access to Founder's Tavern in the End of Time,
                    Every Rune in Heart of the Oasis (1 EX-ZENO), Golden Cube Skin - Angel Skin + Wings, Discord Badge +
                ...
                <ul role="list">
                  <li>
                    Homage NFTs - 50 items with 4 rarities each (200 total). These items will be inspired by,&nbsp;and
                    in the style of, Diablo 2.
                  </li>
                  <li>
                  ...
                  <li>
                    Land Title NFTs - TBD. Land titles will give you an open area to build your own city, arena, or even
                    a modded story arc within Heart of the Oasis (limitations).
                  </li>
                  <li>
                  ...
                  <li>
                    DLC NFTs - TBD. DLC&nbsp;items will allow you to unlock specific areas or arcs within Arken: Heart
                    of the Oasis, that could otherwise be difficult to unlock during gameplay.{' '}
                  </li>
                </ul>
              </div>
            </div>

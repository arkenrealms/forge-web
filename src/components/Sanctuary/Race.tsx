...
const Race = function ({ id }) {
  ...
  if (races.length && !race) return <>Not found</>;
  if (!race)
    return (
    ...
    <>
      ...
      <main className="content-wrapper body-5 lore wf-section">
        <div className="class-header">
          <div className="w-layout-grid grid-class-header">
            <div className="div-block-46">
              <h1 className="page-title act-title">{race.name}</h1>
              <div className="w-richtext">
                {/* <ReactMarkdown remarkPlugins={[linker, remarkGfm]}>{race.description}</ReactMarkdown> */}
                <Linker id="race-1">{race.description}</Linker>
              </div>
              <br />
              <br />
              <div className="w-richtext">
                <ReactMarkdown remarkPlugins={[remarkGfm]}>{race.lore2}</ReactMarkdown>
              </div>
              <br />
              <br />
              <div className="w-richtext">
                <ReactMarkdown remarkPlugins={[remarkGfm]}>{race.lore3}</ReactMarkdown>
              </div>
            </div>

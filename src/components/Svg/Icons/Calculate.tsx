  ...
  return (
    <Svg viewBox="0 0 18 18" {...props}>
      <path
        ...
        fill="#ffffff"
      />
      <path d="M8.25 4.72H3.25V6.22H8.25V4.72Z" fill="#ffffff" />
      <path d="M15 12.75H10V14.25H15V12.75Z" fill="#ffffff" />
      <path d="M15 10.25H10V11.75H15V10.25Z" fill="#ffffff" />
      <path d="M5 15H6.5V13H8.5V11.5H6.5V9.5H5V11.5H3V13H5V15Z" fill="#ffffff" />
      <path

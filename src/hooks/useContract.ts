...
import ArcaneBarracksV1 from 'rune-backend-sdk/build/contracts/ArcaneBarracksV1.json'
import ArcaneItemStorageV1 from 'rune-backend-sdk/build/contracts/ArcaneItemStorageV1.json'
import ArcaneWorldstoneMinterV1 from 'rune-backend-sdk/build/contracts/ArcaneWorldstoneMinterV1.json'
import ArcaneBlacksmithV4 from 'rune-backend-sdk/build/contracts/ArcaneBlacksmithV4.json'
import RuneSenderV1 from 'rune-backend-sdk/build/contracts/RuneSenderV1.json'
import RuneShards from 'rune-backend-sdk/build/contracts/RuneShards.json'
import ArcaneTraderV1 from 'rune-backend-sdk/build/contracts/ArcaneTraderV1.json'
import RxsMarketplace from 'rune-backend-sdk/build/contracts/RXSMarketplace.json'

...
import ArcaneBarracksV1 from '@arken/node/contracts/ArcaneBarracksV1.json';
import ArcaneItemStorageV1 from '@arken/node/contracts/ArcaneItemStorageV1.json';
import ArcaneWorldstoneMinterV1 from '@arken/node/contracts/ArcaneWorldstoneMinterV1.json';
import ArcaneBlacksmithV4 from '@arken/node/contracts/ArcaneBlacksmithV4.json';
import RuneSenderV1 from '@arken/node/contracts/RuneSenderV1.json';
import RuneShards from '@arken/node/contracts/RuneShards.json';

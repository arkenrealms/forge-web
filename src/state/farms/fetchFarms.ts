  ...
  const data = await Promise.all(
    farmsConfig
      ...
      .map(async (farmConfig) => {
        ...
        const [info, totalAllocPoint, runePerBlock] = await multicall(masterchefABI, [
          {
        ...
        //   getBalanceNumber(quoteTokenBlanceLP),
        //   getBalanceNumber(lpTokenBalanceMC),
        //   getBalanceNumber(lpTotalSupply),
        //   getBalanceNumber(tokenDecimals),
        //   getBalanceNumber(quoteTokenDecimals),
        //   getBalanceNumber(tokenPriceVsQuote),

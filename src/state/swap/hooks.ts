...
import { Currency, CurrencyAmount, ETHER, JSBI, Token, TokenAmount, Trade } from '@arcanefinance/sdk';
...
export function useDerivedSwapInfo(): {
  ...
  if (balanceIn && amountIn && balanceIn.lessThan(amountIn)) {
    inputError = `Insufficient ${symbolMap(amountIn.currency.symbol)} balance`;
  }

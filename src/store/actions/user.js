...
export const toggleMatrix = (matrixOn) => ({
  type: TOGGLE_MATRIX,
  payload: matrixOn,
})
export const toggleDistortion = (distortionOn) => ({
  type: TOGGLE_DISTORTION,
  payload: distortionOn,
})
export const setDistortionIntensity = (intensity) => ({
  type: SET_DISTORTION_INTENSITY,
  payload: intensity,
})

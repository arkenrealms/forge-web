...
//     if (item.id === 1) {
//       item.mods[0].attributeId = ItemAttributesByName[1].HarvestYield.id
//       item.mods[1].attributeId = ItemAttributesByName[1].HarvestFee.id
//       item.mods[2].attributeId = ItemAttributesByName[1].HarvestFeeToken.id
//     } else if (item.id === 2) {
//       item.mods[0].attributeId = ItemAttributesByName[1].HarvestYield.id
//       item.mods[1].attributeId = ItemAttributesByName[1].SendHarvestHiddenPool.id
//       item.mods[2].attributeId = ItemAttributesByName[1].BurnEntireHarvest.id
//     } else if (item.id === 3) {
//       item.mods[0].attributeId = ItemAttributesByName[1].HarvestYield.id
//       item.mods[1].attributeId = ItemAttributesByName[1].HarvestBurn.id
//       item.mods[2].attributeId = ItemAttributesByName[1].FindShard.id
//       delete item.mods[3]
//       delete item.mods[4]
//       delete item.mods[5]
//       delete item.mods[6]
...
//     } else if (item.id === 4) {
//       item.mods[0].attributeId = ItemAttributesByName[1].FindShard.id
...
//       if (mod.attributeId === ItemAttributesByName[1].HarvestYield.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].HarvestFee.id) {
//         item.attributes[i] = {
//           ...(item.attributes[i] || {}),
//           ...ItemAttributesById[mod.attributeId],
//           ...branchAttribute,
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].HarvestFeeToken.id) {
//         actionMetadata.harvestFees[branchAttribute.param1.map[mod.value]] = prevMod.value
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].SendHarvestHiddenPool.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].BurnEntireHarvest.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].HarvestBurn.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].FindShard.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].RemoveFees.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].RandomRuneExchange.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].UnstakeLocked.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].SpecificClass.id) {
...
//           ...mod,
//         }
//       } else if (mod.attributeId === ItemAttributesByName[1].Rarity.id) {
...
//         if (
//           attribute.id === ItemAttributesByName[1].RandomPerfection1.id ||
//           attribute.id === ItemAttributesByName[1].RandomPerfection2.id ||
//           attribute.id === ItemAttributesByName[1].RandomPerfection3.id ||
//           attribute.id === ItemAttributesByName[1].RandomPerfection4.id ||
//           attribute.id === ItemAttributesByName[1].RandomPerfection5.id
//         )
//           continue

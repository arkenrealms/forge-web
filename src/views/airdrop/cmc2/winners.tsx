...
const Rules = () => {
  ...
  const mythicItem = decodeItem('1003000321420400032034002207300320130202000000200000020000002000000001');
  const epicItem = decodeItem('1003000321420400042034001207300320130182000000200000020000002000000001');
  const rareItem = decodeItem('1003000321420400052034001207300220130162000000200000020000002000000001');
  const magicalItem = decodeItem('1003000321420400062034000207300120130142000000200000020000002000000001');
              ...
              <Text>
                ...
                <Flex flexDirection="column" alignItems="center" justifyContent="center">
                  ...
                  {winners
                    ...
                    .map((winner) => {
                      return <p>{winner.address} - Mythic Luminous Flywings</p>;
                    })}
                  <br />
                  <br />
                  ...
                  {winners
                    ...
                    .map((winner) => {
                      return <p>{winner.address} - Epic Luminous Flywings</p>;
                    })}
                  <br />
                  <br />
                  ...
                  {winners
                    ...
                    .map((winner) => {
                      return <p>{winner.address} - Rare Luminous Flywings</p>;
                    })}
                  <br />
                  <br />
                  ...
                  {winners
                    ...
                    .map((winner) => {
                      return <p>{winner.address} - Magical Luminous Flywings</p>;
                    })}
                </Flex>
              </Text>
            </CardBody>

      ...
      <Card>
        ...
        <CardBody>
          ...
          <Flex
            ...
            {i18n.language === 'es' ? (
              <iframe
                src="https://www.youtube.com/embed/mFuLU60SgOU"
              ...
              <iframe
                src="https://www.youtube.com/embed/vfxzgR93410"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ...
              <iframe
                src="https://www.youtube.com/embed/An6cfGF0YaA"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ...
              <iframe
                src="https://www.youtube.com/embed/8EfdNqnTXjk"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ...
              <iframe
                src="https://www.youtube.com/embed/me_bMNbIStY"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
              ...
              <iframe
                src="https://www.youtube.com/embed/cejd-7BDVYg"
                title="YouTube video player"
                frameBorder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowFullScreen
          ...
          {tabIndex === 2 ? (
            <Flex flexDirection="column" alignItems="left" mb="8px" justifyContent="start">
              ...
              <HelpText>
                ...
                <br />
                <ul>
                  <li>Points Per Evolve: 1</li>

                  <li>Points Per Powerup: 1</li>

                  <li>Points Per Kill: 20</li>

                  <li>Points Per Reward: 5</li>
                </ul>
              </HelpText>
              <br />
              <br />
              ...
              <HelpText>
                ...
                <br />
                <ul>
                  <li>Points Per Kill: -200</li>

                  <li>Orb Delay Seconds: 9999 (Death Orbs do not spawn)</li>

                  <li>Orb On Death Percent: 0</li>
                </ul>
              </HelpText>
              <br />
              <iframe
              ...
              <HelpText>
                ...
                <br />
                <ul>
                  <li>Points Per Kill: 300</li>

                  <li>Orb On Death Percent: 0</li>

                  <li>Orb Delay Seconds: 9999 (Death Orbs do not spawn)</li>

                  <li>Points Per Evolve: 0</li>

                  <li>Points Per Powerup: 1</li>

                  <li>Points Per Reward: 0</li>
              ...
              <HelpText>
                ...
                <br />
                <ul>
                  <li>Orb On Death Percent: 25</li>

                  <li>Orb Delay Seconds: 3</li>

                  <li>Points Per Orb: 200</li>

                  <li>Points Per Evolve: 0</li>

                  <li>Points Per Reward: 0</li>

                  <li>Points Per Kill: 0</li>
              ...
              <HelpText>
                ...
                <br />
                <ul>
                  <li>Sprites Per Player Count: 20</li>
              ...
              <HelpText>
                ...
                <br />
                <ul>
                  <li>Avatar Speed Multiplier Drake: 1.5</li>

                  <li>Decay Power: 4</li>

                  <li>Immunity Seconds: 20 (Initial immunity bubble lasts longer.)</li>

                  <li>Orb On Death Percent: 0</li>

                  <li>Orb Timeout Seconds: 9999 (Death Orbs do not spawn)</li>
                </ul>
              </HelpText>
              <br />
              <iframe
              ...
              <HelpText>
                ...
                <ul>
                  ...
                  <li>Points Per Evolve: 25</li>

                  <li>Decay Power: -3 (Life gained automatically)</li>

                  <li>Avatar Decay Power (Dragonling): 4</li>

                  <li>Avatar Decay Power (Whelp): 3</li>

                  <li>Avatar Decay Power (Drake): 2</li>

                  <li>Sprite Life Multiplier: -1</li>
                </ul>
              </HelpText>
              <br />
              <Heading color="contrast" size="lg" style={{ marginTop: 20 }}>
              ...
              <HelpText>
                ...
                <ul>
                  ...
                  <li>Sprite Life Multiplier: -1 (sprites take life instead)</li>
                </ul>
              </HelpText>
              <br />
              <Heading color="contrast" size="lg" style={{ marginTop: 20 }}>
              ...
              <HelpText>
                ...
                zoomed in, and everybody moves the same speed. Additionally, each sprite color has an affect on your
                camera size.
                <ul>
                  <li>Blue - Zoom out camera a lot (great)</li>
                  <li>Yellow - Zoom out camera a little (good)</li>
                  <li>Pink - Zoom in camera a little (bad)</li>
                  <li>Purple - Zoom in camera a lot (horrible)</li>
                  <li>Camera Size: 2</li>
                  <li>Base Speed: 2.5</li>
                  <li>Decay Power: 1.4</li>
                  <li>Avatar Decay Power (Dragonling): 1</li>
                  <li>Avatar Decay Power (Whelp): 1</li>
                  <li>Avatar Decay Power (Drake): 1</li>
                </ul>
                <br />
              </HelpText>
              <br />
              ...
              <HelpText>
                ...
                <ul>
                  ...
                  <li>Dynamic Decay Power: true</li>

                  <li>Decay Power Per Max Evolved Players: 1</li>
                </ul>
              </HelpText>
              <br />
              <Heading color="contrast" size="lg" style={{ marginTop: 20 }}>
              ...
              <br />
              <HelpText>
                Each sprite in this game mode has a different effect:
                <br />
                <ul>
                  <li>Blue - Shield (positive)</li>
                  <li>Yellow - Increase Speed + Decrease Decay (positive, but negative if too fast)</li>
                  <li>Pink - Decrease Speed (negative, but positive if too fast)</li>
                  <li>Purple - Increase Decay (negative)</li>
                </ul>
              </HelpText>
              <br />
              <br />

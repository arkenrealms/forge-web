      ...
      <BigCard>
        <CardBody>
          ...
          <p>
            ...
            attributes suitable for a specific hero class or style of play. Equip your hero with Runeforms to make them
            more powerful in battle, increase magic find, or improve farming and merchant abilities. Runeforms can be
            taken between games in the Arken ecosystem, collected, shared, and traded in the Arken Market. Soon you'll
            be able to lend your Runeforms to guild members or through the Marketplace.
          </p>
          <br />
          <p>
      ...
      <BigCard>
        <CardBody>
          ...
          <p>
            ...
            distributed to players through the Arken ecosystem over a two year period. There are currently {totalRunes}{' '}
            released. Each rune builds on the last, expanding the universe with new storylines, games, and unique

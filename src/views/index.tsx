...
const BinzyComponent = lazy(() => import(/* webpackChunkName: "BinzyComponent" */ '~/components/Binzy'));
...
const Home: React.FC<any> = ({ active, match }) => {
  ...
  const refBinzySection = useRef(null);
  const isBinzySectionVisible = useIntersectionObserver(refBinzySection);

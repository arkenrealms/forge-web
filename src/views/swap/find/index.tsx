import { Currency, ETHER, JSBI, TokenAmount } from '@arcanefinance/sdk'
import { css } from 'styled-components'
import React, { useCallback, useEffect, useState } from 'react'
import { Button, ChevronDownIcon, AddIcon, CardBody, Text } from '~/ui'
...
export default function PoolFinder({ active }) {

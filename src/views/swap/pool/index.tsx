import { Pair } from '@arcanefinance/sdk'
...
import { Button, CardBody, Text } from '~/ui'
...
export default function Pool({ active }) {
    ...
    <Page
      ...
      <AppBody>
        <PageHeader
          ...
          <Button id="join-pool-button" as={Link} to="/swap/add/BNB">
